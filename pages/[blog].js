  ...
  return (
    <section className="section">
      <Head>
        ...
        <link rel="apple-touch-icon" href="/https://png.pngtree.com/png-vector/20230227/ourmid/pngtree-happy-womens-day-calligraphy-greetings-png-image_6621284.png" />
        <link rel="manifest" href="/manifest.json" />
        <meta name="theme-color" content="#000000" />
        <title>{`${
          wishername +
          " Wishing you a Happy Women's Day (Chúc các bạn nữ lớp A11 một ngày 20-10 thật vui vẻ, hạnh phúc và tràn đầy tiếng cười) 💛"
        }`}</title>
        <meta
          name="description"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              publisher: {
                "@type": "Organization",
                name: `${wishername} Wishing you a Happy Women's Day (Chúc các bạn nữ lớp A11 một ngày 20-10 thật vui vẻ, hạnh phúc và tràn đầy tiếng cười) 💛`,
                url: `${pathname}`,
                logo: {
                  "@type": "ImageObject",
          ...
          dangerouslySetInnerHTML={{
            ...
            if(true) {
              ...
              gtag('config', 'G-71LZH45GM6', {
                'page_title' : '${wishername} Wishing you a Happy Womens Day (Chúc các bạn nữ lớp A11 một ngày 20-10 thật vui vẻ, hạnh phúc và tràn đầy tiếng cười) 💛',
